...
namespace Hunter.Models
{
    ...
    public class Shop_ItemMenager
    {
        ...
        public static List<Shop_ItemList> getInstance()
        {
            ...
            lists.Add(new Shop_ItemList { name = "跳关卡" ,cost = 1000, content="跳过此关卡"});
            lists.Add(new Shop_ItemList { name = "双倍积分卡", cost=500, content="一段时间内积分值获取量翻倍"});
            lists.Add(new Shop_ItemList { name = "好人卡", cost=100, content="积分有些多，拿出做贡献，并没什么卵用" });
            return lists;
        }
    }
}
